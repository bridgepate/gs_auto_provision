CONFIG = {
          ...
          :'gxp2130-009' => {
            ...
            :ipaddress => '10.28.1.9',
            :config => 'base2130conf.rb',
            :accounts => {'1' => {:extension => '7404',:dn => 'kclarkhoward',:displayname => 'Kayleen Clark-Howard'},'2' => {:extension => '7131',:displayname => '3A'}}
          },
          :'gxp2130-010' => {
     ...
     :'gxp2130-020' => {
          ...
          :'gxp2130-025' => {
            ...
            :config => 'base2130conf.rb',
            :accounts => {'1' => {:extension => '7432',:dn => 'khumphreys',:displayname => 'khumphreys'},'2' => {:extension => '7144',:displayname => '4D'}}
          },
            :'gxp2130-038' => {
          ...
          :'gxp2140-073' => {
            ...
            :config => 'base2140conf.rb',
            :accounts => {'1' => {:extension => '7223',:displayname => 'Consellor'}}
          },
          :'gxp2140-074' => {
            :macaddress => '000B82629E99',
            :ipaddress => '10.28.1.74',
            :config => 'base2140conf.rb',
            :accounts => {'1' => {:extension => '7224',:displayname => 'Support'}}
          },
          :'gxp2140-075' => {
          ...
          :'gxp2140-081' => {
            ...
            :config => 'base2140conf.rb',
            :accounts => {'1' => {:extension => '7215',:displayname => 'Hotdesk'}}
          },
          :'gxp2140-082' => {
