CONFIG = {
  :'gxp2130-005' => {
    :macaddress => '000B82775052',
    :ipaddress => '10.28.1.5',
    :config => 'teacher-std.yml',
    #    :accounts => {:account1 => '1111,1,Brijesh Patel', :account2 => '1000,2,Mario Becroft'}
    :accounts => {'1' => {:extension => '7400',:dn => 'rmartin',:displayname => 'Ross Martin'},'2' => {:extension => '7131',:displayname => '3A'}}
    
  },
  :'gxp2130-006' => {
    :macaddress => '000B82775058',
    :ipaddress => '10.28.1.6',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7401',:dn => 'lpopli',:displayname => 'Lekha Popli'},'2' => {:extension => '7131',:displayname => '3A'}}
  },
  :'gxp2130-007' => {
    :macaddress => '000B82775053',
    :ipaddress => '10.28.1.7',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7402',:dn => 'ghackett',:displayname => 'Georgina Hackett'},'2' => {:extension => '7131',:displayname => '3A'}}
  },
  :'gxp2130-008' => {
    :macaddress => '000B82775057',
    :ipaddress => '10.28.1.8',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7403',:dn => 'tsharp',:displayname => 'Trevor Sharp'},'2' => {:extension => '7131',:displayname => '3A'}}
  },
  :'gxp2130-009' => {
    :macaddress => '000B82775054',
    :ipaddress => '10.28.1.9',
    :config => 'teacher-kclarkhoward.yml',
    :accounts => {
      '1' => {
        :extension => '7404',
        :displayname => 'Kayleen Clark-Howard'},
      '2' => {
        :extension => '7131',
        :displayname => '3A'
      }
  ...
  :'gxp2130-010' => {
    :macaddress => '000B826AA488',
    :ipaddress => '10.28.1.10',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7405',:dn => 'mkerr',:displayname => 'Matt Kerr'},'2' => {:extension => '7131',:displayname => '3A'}}
  },
  :'gxp2130-011' => {
    :macaddress => '000B82775059',
  ...
  :'gxp2130-013' => {
    ...
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7408',:dn => 'jking',:displayname => 'Jessica King'},'2' => {:extension => '7132',:displayname => '3B'}}
  },
  :'gxp2130-014' => {
    :macaddress => '000B82775002',
    :ipaddress => '10.28.1.14',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7409',:dn => 'spatten',:displayname => 'Soh Chin Patten'},'2' => {:extension => '7132',:displayname => '3B'}}
  },
  :'gxp2130-015' => {
    :macaddress => '000B82775005',
    :ipaddress => '10.28.1.15',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7410',:dn => 'nwebster',:displayname => 'Naomi Webster'},'2' => {:extension => '7132',:displayname => '3B'}}
  },
  :'gxp2130-016' => {
    :macaddress => '000B82775004',
    :ipaddress => '10.28.1.16',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7411',:dn => 'mpinkerton',:displayname => 'Micheala Pinkerton'},'2' => {:extension => '7132',:displayname => '3B'}}
  },
  :'gxp2130-017' => {
    :macaddress => '000B82775008',
    :ipaddress => '10.28.1.17',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7412',:dn => 'sfausett',:displayname => 'Sally Fausett'},'2' => {:extension => '7141',:displayname => '4A'}}
  },
  :'gxp2130-018' => {
    :macaddress => '000B82775006',
    :ipaddress => '10.28.1.18',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7413',:dn => 'sclosey',:displayname => 'Shirley Closey'},'2' => {:extension => '7141',:displayname => '4A'}}
  },
  :'gxp2130-019' => {
    :macaddress => '000B82775009',
    :ipaddress => '10.28.1.19',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7414',:dn => 'schesterman',:displayname => 'Sandra Chesterman'},'2' => {:extension => '7141',:displayname => '4A'}}
  },
  :'gxp2130-020' => {
    :macaddress => '000B82775003',
    :ipaddress => '10.28.1.20',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7415',:dn => 'lmoore',:displayname => 'Louise Moore'},'2' => {:extension => '7141',:displayname => '4A'}}
  },
  :'gxp2130-021' => {
    :macaddress => '000B82775944',
    :ipaddress => '10.28.1.21',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7416',:dn => 'njenkins',:displayname => 'Nikki Jenkins'},'2' => {:extension => '7141',:displayname => '4A'}}
  },
  :'gxp2130-022' => {
    :macaddress => '000B82775946',
    :ipaddress => '10.28.1.22',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7417',:dn => 'myu',:displayname => 'Milton Yu'},'2' => {:extension => '7141',:displayname => '4A'}}
  },
  :'gxp2130-023' => {
    :macaddress => '000B82775056',
    :ipaddress => '10.28.1.23',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7418',:dn => 'kplatzer',:displayname => 'Kay-Marie Platzer'},'2' => {:extension => '7142',:displayname => '4B'}}
  },
  :'gxp2130-024' => {
    :macaddress => '000B82775945',
    :ipaddress => '10.28.1.24',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7419',:dn => 'kharvey',:displayname => 'Kevin Harvey'},'2' => {:extension => '7142',:displayname => '4B'}}
  },
  :'gxp2130-025' => {
    :macaddress => '000B826AA483',
    :ipaddress => '10.28.1.25',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7420',:dn => 'mkim',:displayname => 'Myung Suk Kim'},'2' => {:extension => '7142',:displayname => '4B'}}
  },
  :'gxp2130-026' => {
    :macaddress => '000B826AA484',
    :ipaddress => '10.28.1.26',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7421',:dn => 'kmain',:displayname => 'Katriona Main'},'2' => {:extension => '7142',:displayname => '4B'}}
  },
  :'gxp2130-027' => {
    :macaddress => '000B826AA487',
    :ipaddress => '10.28.1.27',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7422',:dn => 'lwiseman',:displayname => 'Linda Wiseman'},'2' => {:extension => '7142',:displayname => '4B'}}
  },
  :'gxp2130-028' => {
    :macaddress => '000B826AA486',
    :ipaddress => '10.28.1.28',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7423',:dn => 'nwilson',:displayname => 'Nick Wilson'},'2' => {:extension => '7142',:displayname => '4B'}}
  },
  :'gxp2130-029' => {
    :macaddress => '000B82774F05',
    :ipaddress => '10.28.1.29',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7424',:dn => 'svanpraag',:displayname => 'Sally Van Praag'},'2' => {:extension => '7143',:displayname => '4C'}}
  },
  :'gxp2130-030' => {
  ...
  :'gxp2130-031' => {
    ...
    :ipaddress => '10.28.1.31',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7426',:dn => 'mjuma',:displayname => 'Marwan Juma'},'2' => {:extension => '7143',:displayname => '4C'}}
  },
  :'gxp2130-032' => {
    :macaddress => '000B826AA482',
    :ipaddress => '10.28.1.32',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7427',:dn => 'ccasey',:displayname => 'Christina Casey'},'2' => {:extension => '7143',:displayname => '4C'}}
  },
  :'gxp2130-033' => {
    :macaddress => '000B82774F08',
    :ipaddress => '10.28.1.33',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7428',:dn => 'tcook',:displayname => 'Tim Cook'},'2' => {:extension => '7143',:displayname => '4C'}}
  },
  :'gxp2130-034' => {
  ...
  :'gxp2130-035' => {
    ...
    :ipaddress => '10.28.1.35',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7430',:dn => 'danderson',:displayname => 'Deborah Anderson'},'2' => {:extension => '7144',:displayname => '4D'}}
  },
  :'gxp2130-036' => {
    :macaddress => '000B82775040',
    :ipaddress => '10.28.1.36',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7431',:dn => 'nlow',:displayname => 'Natasha Low'},'2' => {:extension => '7144',:displayname => '4D'}}
  },
  :'gxp2130-037' => {
    :macaddress => '000B82774F02',
    :ipaddress => '10.28.1.37',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7432',:dn => 'khumphreys',:displayname => 'Kayla Humphreys'},'2' => {:extension => '7144',:displayname => '4D'}}
  },
  :'gxp2130-038' => {
    :macaddress => '000B8277503A',
    :ipaddress => '10.28.1.38',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7433',:dn => 'bmahmoud',:displayname => 'Bassam Mahmoud'},'2' => {:extension => '7144',:displayname => '4D'}}
  },
  :'gxp2130-039' => {
    :macaddress => '000B82775948',
    :ipaddress => '10.28.1.39',
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7434',:dn => 'ngarton',:displayname => 'Nathan Garton'},'2' => {:extension => '7144',:displayname => '4D'}}
  },
  :'gxp2130-040' => {
    :macaddress => '000B82775947',
    :ipaddress => '10.28.1.40',
    :config => 'teacher-std.yml',
  ...
  :'gxp2130-047' => {
    ...
    :config => 'teacher-std.yml',
    :accounts => {'1' => {:extension => '7442',:dn => 'tshaw',:displayname => 'Tony Shaw'},'2' => {:extension => '7154',:displayname => '5D'}}
  },
  :'gxp2130-048' => {
  ...
  :'gxp2130-053' => {
    :macaddress => '000B82774DBA',
    :ipaddress => '10.28.1.53',
    :config => 'teacher-std.yml',
    :accounts => {
      '1' => {:extension => '7910', :displayname => 'Test user'},
      '2' => {:extension => '7911', :displayname => 'Test loc'}
    }
  },
  :'gxp2140-071' => {
  ...
  :'gxp2140-081' => {
    :macaddress => '000B8264BE09',
    :ipaddress => '10.28.1.81',
    :config => 'admin-rtaylor.yml',
    :accounts => {'1' => {:extension => '7215',:displayname => 'Ronwyn Taylor'}}
  },
  :'gxp2140-082' => {
